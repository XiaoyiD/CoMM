        ...
        for epoch in range(self.epoch):
            ...
            for step, train_data in enumerate(self.train_data_loader):
                ...
                if 'contrastive_loss' in results:
                    ...
                    loss = loss + self.loss_coefficient['contrastive_loss'] * contrastive_loss
                    print_str = print_str + ';\t contrastive_loss: ' + str(contrastive_loss.item())
                ...
                if epoch % self.show_epoch == 0 and step == 0:
                    ...
                    # add contrastive loss
                    if 'contrastive_loss' in results:
                        print("the model has contrastive_loss")
                        epoch_loss['contrastive_loss'] = contrastive_loss.item()
                    else:
                        epoch_loss['contrastive_loss'] = 0
